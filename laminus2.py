...
class Laminus:
    ...
    def __init__(self, **window):
        ...
        self.filemenu.add_command(label="Quick Wizard",command=self.introstart)
...
laminus1 = Laminus(width=1200, height=800)
laminus1.introstart()
